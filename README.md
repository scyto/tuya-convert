...
* copy docker/docker-compose.sample.yml to your docker host as docker-compose.yml
* the only env var you should need to change is the AP if your wifi adapter on the host is not wlan0
